...
def calculate_frequencies(file_contents):
    ...
    #        removed_punctuations = removed_punctuations + i
        
    file_contents_splited = removed_punctuations.lower().split()
    word_list = {}
    for i in file_contents_splited:
    ...
    cloud.generate_from_frequencies(word_list)
